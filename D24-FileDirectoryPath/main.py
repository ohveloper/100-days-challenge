# # 절대 경로
# with open("/Users/ohveloper/Desktop/my_file.txt", mode="w") as data:
#     data.write("hello world")
#     # print(contents)
#
# with open("/Users/ohveloper/Desktop/my_file.txt") as data:
#     contents = data.read()
#     print(contents)

# 상대 경로
with open("../../../Desktop/my_file.txt") as data:
    contents = data.read()
    print(contents)
